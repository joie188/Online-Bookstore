...
public class AddressBean
{
   ...
   public void delete(String firstName, String lastName) throws SQLException
   {
      ...
      try
      {
        // create a PreparedStatement to delete the address book entry
        PreparedStatement deleteEntry =
            connection.prepareStatement( "DELETE FROM ADDRESSES WHERE FIRSTNAME = ? AND LASTNAME = ?");

        deleteEntry.setString( 1, firstName );
        deleteEntry.setString( 2, lastName );
